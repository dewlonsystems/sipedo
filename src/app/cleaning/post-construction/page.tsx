...
const serviceData = {
  ...
  content: `
    ...
    <h3>Why Choose Sipedo for Post-Construction Cleaning?</h3>
    <ul class="list-disc pl-5 space-y-2 mt-4">
      <li><strong>Same-week availability</strong> — we know timelines are tight</li>
      <li><strong>Trained & insured team</strong> — uniformed professionals you can trust</li>
      <li><strong>Eco-friendly products</strong> — safe for your family and new finishes</li>
      <li><strong>100% satisfaction guarantee</strong> — we don’t leave until it’s perfect</li>
    </ul>

    <p>Serving Westlands, Karen, Thika, Kiambu, and all Nairobi construction sites.</p>
  `,
};
    ...
    <>
      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Post-Construction Cleaning in Nairobi"
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-bg">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8">Professional post-construction cleaning in Nairobi — fast, thorough, and guaranteed.</p>
          <Link 
            href="/contact" 
